...
class EditInformationCustomerFragment : Fragment() {
 lateinit var viewBinding : FragmentEditInformationCustomerBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentEditInformationCustomerBinding.inflate(layoutInflater)
    ...
    private fun saveChanges() {
        ...
        if (!validateData(firstName, lastName, phoneNumber)) {
            return
        }
        updateFirestore(firstName, lastName, phoneNumber)
    }
    ...
    private fun updateFirestore(firstName: String, lastName: String, phoneNumber: String) {
        val newData = getNewUserData(firstName, lastName, phoneNumber)
    ...
    private fun getNewUserData(firstName: String, lastName: String, phoneNumber: String): Map<String, Any> {
    ...
    private fun openImageChooser() {
        ...
        intent.type = "image/*"
        startActivityForResult(intent, EditInformationCustomerFragment.REQUEST_CODE_IMAGE)
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        super.onActivityResult(requestCode, resultCode, data)
        if (requestCode == EditInformationCustomerFragment.REQUEST_CODE_IMAGE && resultCode == Activity.RESULT_OK) {
            data?.data?.let {
                selectedImg = it
